 ...
 * 合规口径：应象一律表述为空间宜忌与使用建议，不作人身祸福、疾病、生育、财运预测；
 * 因文字经改写，相关条目 level 由「原书明文」下调为「原书演绎」。改动需与服务端 engine.py 同步。
 */
(function(root){
...
const YX = {
"生气":{"star":"贪狼木","level":"原书演绎","吉":"上吉","应象":"此宫气机最活，宜作主卧、书房或日常活动区；宜明亮通透、宜开门开窗，忌长期闲置封闭（据子息歌、八星吉凶总要「临宫得位」演绎）","应期":"亥卯未（木局）年月"},
"天医":{"star":"巨门土","level":"原书演绎","吉":"次吉","应象":"此宫宜静中有养，适合作卧室与休息区；宜高大方正、陈设安稳，忌堆压杂物与长期闭塞（据星宫生克论「天医宜高大」演绎）","应期":"土神之年（土无三合局，细则存疑）"},
"延年":{"star":"武曲金","level":"原书演绎","吉":"次吉","应象":"此宫宜作主要起居与会客之处，利于家人共处与日常安顿；宜方正整洁，忌零乱与穿堂直冲（据星宫生克论「延年得位主向为妙」演绎）","应期":"巳酉丑（金局）年月"},
"伏位":{"star":"左辅/右弼","level":"原书明文+演绎","吉":"辅弼小凶/无定","应象":"左辅阴木次凶；右弼所属无定，休咎随向星（原书：惟有右弼无生克，休咎翻随向星云）。门宫伏位本身主安稳（演绎）","应期":"亥卯未（辅弼木合局论）"},
"五鬼":{"star":"廉贞火","level":"原书演绎","吉":"大凶","应象":"此宫气性躁急，宜静宜整洁，忌作长期起居与堆积杂物；尤忌闭塞不通，宜保持通风与定期清理，明火与电器亦宜留意（据原书「火性本烈况居离宫」与师承气法演绎）","应期":"寅午戌（火局）年月"},
"六煞":{"star":"文曲水","level":"原书演绎","吉":"次凶","应象":"此宫气散不聚，宜简洁少动，不宜安排长期起居与重要功能区；忌水汽积滞与陈设繁杂（据星宫生克论「震巽逢文曲多浮华不实，水泛木浮」演绎）","应期":"申子辰（水局）年月"},
"祸害":{"star":"禄存土","level":"原书演绎","吉":"次凶","应象":"此宫气滞易郁，宜作储物、卫浴等次要功能，不宜久居；储物须留泄口，不可封死成窝（据子息歌、断静宅要诀演绎）","应期":"土神之年（同天医）"},
"绝命":{"star":"破军金","level":"原书演绎","吉":"大凶","应象":"此宫气最不聚，宜静宜闭、宜整洁少动，不宜作主卧或长期停留之处；星宫相克时次凶（据子息歌演绎）","应期":"巳酉丑（金局）年月"}};
...
const ZONGJUE = "气贵流通忌直穿，曲中有情聚为先；尽头无泄名窝气，久窝气滞宜早疏；多转停驻是死气，滞重之象宫上断；背后来风冲坐卧，宜加屏障安其位；白矾收气酉亥下，吉星宫位矾莫沾；打洞两指从内出，泄煞通气是上端；小窝用盐通气场，灶座背后实墙填；吉方流通凶方静，藏风聚气宅自宁。";
